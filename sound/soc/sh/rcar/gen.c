			   ...
			   struct rsnd_priv *priv)
{
	...
	struct rsnd_regmap_field_conf conf_ssiu[] = {
		...
		RSND_GEN_S_REG(SSI_SYS_INT_EN0,	0x850),
		RSND_GEN_S_REG(SSI_SYS_INT_EN1,	0x854),
		RSND_GEN_S_REG(SSI_SYS_INT_EN2,	0x858),
		RSND_GEN_S_REG(SSI_SYS_INT_EN3,	0x85c),
		RSND_GEN_M_REG(SSI_BUSIF_MODE,	0x0,	0x80),
		RSND_GEN_M_REG(SSI_BUSIF_ADINR,	0x4,	0x80),
		RSND_GEN_M_REG(BUSIF_DALIGN,	0x8,	0x80),
		RSND_GEN_M_REG(SSI_CTRL,	0x10,	0x80),
		RSND_GEN_M_REG(STATUS,		0x14,	0x80),
	...
	struct rsnd_regmap_field_conf conf_scu[] = {
		...
		RSND_GEN_M_REG(SRC_STATUS,	0x14,	0x20),
		RSND_GEN_M_REG(SRC_INT_EN0,	0x18,	0x20),
