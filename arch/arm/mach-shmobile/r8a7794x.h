...
void r8a7794x_add_standard_devices(void);
void r8a7794x_add_dt_devices(void);
void r8a7794x_clock_init(void);
void r8a7794x_pinmux_init(void);
void r8a7794x_pm_init(void);
void r8a7794x_init_early(void);
void r8a7794x_timer_init(void);
extern struct smp_operations r8a7794x_smp_ops;

#ifdef CONFIG_PM
extern void __init r8a7794x_init_pm_domains(void);
#else
static inline void r8a7794x_init_pm_domains(void) {}
#endif /* CONFIG_PM */
